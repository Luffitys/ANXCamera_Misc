...
:: Compress --> zip
"C:\Program Files\7-Zip\7z.exe" a "D:\ANXCamera\ANXCamera_Magisk\ANXCamera_Unity_143.ShootingStarGalaxy_sysover.zip" -xr!.git* -xr!LICENSE -r "D:\ANXCamera\ANXCamera_Magisk\*" -mx9
